...
function CreateGameSchedule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Game schedule created successfully');
      navigate('/schedule');
    } catch (error) {
      toast.error(error.message || 'Failed to create game schedule');
    } finally {
  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-900">Create Game Schedule</h1>
      </header>
