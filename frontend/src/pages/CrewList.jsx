...
import { Search, Filter, Trash2, AlertCircle, Download, UserPlus, Mail, Phone } from 'lucide-react';
...
function CrewList() {
  ...
  const roles = Array.from(
    new Set(crewMembers.map((member) => member.role))
  );
  ...
  const filteredMembers = sortMembers(crewMembers.filter((member) => {
        ...
        <div className="p-6">
              ...
              >
                <div className="p-6">
                  <div className="flex items-center">
                    ...
                    {currentUser?.role === 'ADMIN' && member.userId !== currentUser.userId && (
                      <button
          ...
          {filteredMembers.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">No crew members found</h3>
