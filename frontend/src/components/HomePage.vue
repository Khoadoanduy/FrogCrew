...
const loadUserData = async () => {
  try {
    ...
    if (response.flag) {
      ...
      error.value = response.message || "Failed to load user data";
    }
  } catch (e) {
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <p class="text-gray-600 mb-6">
            Manage crew members, send invitations, and handle crew assignments.
          </p>
          <button
        ...
        >
          ...
          <p class="text-gray-600 mb-6">
            Create and manage game schedules, add games, and assign crew
            members.
          </p>
          <button
