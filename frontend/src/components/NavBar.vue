    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <div class="text-2xl font-bold text-white cursor-pointer font-roboto-slab" @click="navigateTo('/')">
            FrogCrew
          </div>
        ...
        <div class="flex items-center space-x-4">
          <span v-if="currentUser" class="text-sm text-gray-300 font-roboto-slab">
